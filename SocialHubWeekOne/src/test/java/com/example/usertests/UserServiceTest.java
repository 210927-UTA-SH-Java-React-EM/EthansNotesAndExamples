...
public class UserServiceTest {
	...
	private User testUser1 = new User("Test", "User", "TestUser", "testPass");
	private User testUser2 = new User("Test", "User", "UserTest", "password");
	...
	public void testCreatNewUser() {
		User rick = uServ.signUp("Rick", "Sanchez", "RicketyRick", "ilovemorty");
		List<User> userList = uServ.getAllUsers();
	...
	public void testCreateMultipleUsers() {
		User morty = uServ.signUp("Morty", "Smith", "MortDawg", "ihaterick");
		User rick = uServ.signUp("Rick", "Sanchez", "RicketyRick", "ilovemorty");
